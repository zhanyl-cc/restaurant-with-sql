...
<div class="section section-cat-add white-text">
	<div class="section">
    ...
    <div class="section center" style="padding: 40px;">
        <form action="../backends/admin/cat-add.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col s12">
                    <div class="section section-cat-add-btn-remove right">
                        <a href="category-list.php" class="btn main-btn btn-remove">Dismiss</a>
                    </div>
                    <div class="section section-cat-add-btn-add right">
