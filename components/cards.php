<section class="fcards">
    <div class="row card__wrapper">
        <div class="col s12 m12 l4" style="padding: 50px 5px;">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="images/foodimages/banner1.jpeg">
                </div>
        ...
        <div class="col s12 m12 l4" style="padding: 50px 5px;">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="images/foodimages/banner2.jpeg">
                </div>
                <div class="card-content">
        ...
        <div class="col s12 m12 l4" style="padding: 50px 5px;">
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="images/foodimages/banner3.jpeg">
                </div>
                <div class="card-content">
    ...
    <div class="row center">
        <div class="col s12">
            <a href="food-categories.php" class="btn main-btn">More Foods &raquo;</a>
        </div>
    </div>
</section>